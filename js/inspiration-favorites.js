...
(function(){
  ...
  function installStyles(){
    ...
    style.textContent = [
      ...
      '.favorite-filter-btn{appearance:none;-webkit-appearance:none;font:inherit;border:1px solid rgba(17,17,17,.14);background:#fff;color:#111;border-radius:999px;padding:8px 13px;font-size:12px;line-height:1;cursor:pointer;transition:background .18s ease,color .18s ease,border-color .18s ease,transform .18s ease}',
