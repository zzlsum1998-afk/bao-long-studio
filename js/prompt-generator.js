  ...
  "case25": {
    "id": "case25",
    "workflowTemplate": "su-white-model-competition-atmosphere-v1",
    "img": "images/template-su-white-model-atmosphere/result-demo.webp",
    "kicker": "Template Workflow",
    "title": "建筑白模竞赛氛围工作流",
    "scene": "适用：SU 白模 / 建筑体量 / 冷灰竞赛渲染",
    "tags": [
      "工作流模板",
      "白模转译",
      "冷灰竞赛"
    ],
    "prompt": "建筑白模竞赛氛围工作流。以上传白模为唯一结构依据，严格保留视角、体块、开口、凹凸关系、边缘转折、悬挑、连接与细部构件；将纯白模型转译为冷灰、低饱和、克制的竞赛级建筑渲染，并加入少量低存在感植物与轻微材质真实性。AI 不重设计建筑，不自动生成专业结论、文字或未经原图支持的场地内容。"
  }
};
