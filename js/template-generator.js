(() => {
  ...
  const templateConfigs = {
    'ecological-architectural-section-v1': {
      ...
      loading: {
        zh:['正在读取剖面结构','正在匹配生态表达','正在生成淡彩结果'],
        en:['Reading section structure','Matching ecological expression','Generating soft-color result']
      },
      resultSummary: {
        zh:[['结构保护','已启用'],['模板风格','生态淡彩'],['模拟耗时','12.8s']],
    ...
    'architectural-section-soft-color-v1': {
      ...
      loading: {
        zh:['正在读取项目结构','正在匹配模板表达','正在生成淡彩结果'],
        en:['Reading project structure','Matching template language','Generating soft-color result']
      },
      resultSummary: {
        zh:[['结构保护','已启用'],['模板风格','低饱和淡彩'],['模拟耗时','12.8s']],
    ...
    'landscape-section-soft-color-v1': {
      ...
      loading: {
        zh:['正在读取场地关系','正在匹配景观模板','正在生成淡彩结果'],
        en:['Reading site relationships','Matching landscape template','Generating soft-color result']
      },
      resultSummary: {
        zh:[['关系保护','已启用'],['模板风格','景观淡彩'],['模拟耗时','12.8s']],
